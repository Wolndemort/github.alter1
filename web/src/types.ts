...
export type ChatItem = { id: string; role: "user" | "assistant"; text: string; createdAt: number; mediaUrl?: string; mediaMime?: string; filename?: string; artifactId?: string; audioUrl?: string; audioMime?: string; audioAutoplay?: boolean; feedback?: string; actionNotice?: string; streaming?: boolean };
