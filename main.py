...
from utils.tasks import monitor_agents, monitor_checkins, monitor_daily_briefs, monitor_memory_cleanup, monitor_metrics, monitor_personality_imprint, monitor_quota_reminders, monitor_reminders, monitor_subscription_renewals, monitor_subscription_expiry_reminders
...
async def main():
    ...
    asyncio.create_task(monitor_quota_reminders(bot))
