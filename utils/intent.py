...
YOUTUBE_PATTERNS = (
    ...
    r"(?:скинь|пришли|дай|хочу).*ссыл", r"ссылк\w*.*(?:на|про)",
    r"найди.*(ролик|видео)", r"покажи.*(ролик|видео)",
    r"\b(?:скинь|пришли|включи|скачай)\b.*\b(?:песн\w*|музык\w*|трек\w*|аудио)\b",
    r"\b(?:скинь|пришли|найди|покажи|скачай|хочу)\b.*\b(?:видео|ролик|клип)\b",
)
WEB_PATTERNS = (
