...
type ChatItem = { id: string; role: string; text: string; createdAt?: number; mediaUri?: string; mediaMime?: string; mediaFilename?: string; audioUri?: string; audioMime?: string; audioFilename?: string; documentArtifactId?: string; feedback?: "positive" | "negative"; streaming?: boolean };
