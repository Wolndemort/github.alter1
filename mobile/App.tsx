...
export function ChatScreen({ token, onLogout }: { token: string; onLogout: () => void }) {
  ...
  <NotificationModal visible={notificationsVisible} items={notifications} unread={notificationUnread} onClose={() => setNotificationsVisible(false)} onRead={markNotificationRead} onReadAll={markAllNotificationsRead} onOpenChat={() => { setNotificationsVisible(false); setMessage(""); }} />
