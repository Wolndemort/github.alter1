  ...
  <Modal visible={menuVisible} transparent animationType="none" onRequestClose={() => setMenuVisible(false)}>
    <Pressable style={premiumStyles.drawerBackdrop} onPress={() => setMenuVisible(false)}>
      ...
      <Pressable style={premiumStyles.drawerContent} onPress={(event) => event.stopPropagation()}>
        ...
        {!account?.owner ? <Pressable style={premiumStyles.menuAction} onPress={() => setPlansVisible(true)}><Text style={premiumStyles.menuActionText}>Подписка</Text><Text style={premiumStyles.menuActionArrow}>→</Text></Pressable> : <Text style={premiumStyles.ownerBadge}>OWNER · FULL ACCESS</Text>}
